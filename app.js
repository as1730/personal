...
const blank = { sessions: [], todos: [], theme: "light", active: null, settings: { focus: 25, break: 5, longBreak: 15, rounds: 4, auto: false, sound: true } };
let data = read();
let mode = "focus";
...
function stop() { clearInterval(interval); interval = null; data.active = null; save(); $("timerButton").textContent = "start"; }
function playChime() {
...
function startInterval() { interval = setInterval(tick, 1000); $("timerButton").textContent = "pause"; }
function start() {
